    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <h2 class="font-black text-2xl text-slate-950 leading-tight uppercase tracking-tight">Verifikasi Partisipasi Event</h2>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-3xl border-4 border-slate-950 p-6 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)]">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between border-b-4 border-slate-950 pb-4 mb-6 gap-4">
                    <div>
                        ...
                        <h3 class="text-xl font-black text-slate-950 mt-2.5 uppercase tracking-tight">{{ $event->title }}</h3>
                        <p class="text-xs text-slate-400 font-bold uppercase tracking-wider mt-1">{{ $event->description }}</p>
                    </div>
                    <div class="sm:text-right self-start sm:self-auto">
                        <span class="text-[9px] text-slate-400 font-black uppercase tracking-wider block mb-1">Hadiah Partisipasi</span>
                        <span class="inline-block text-2xl font-black text-slate-950 bg-[#E4FF1A] border-2 border-slate-950 px-3 py-1 rounded-xl shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] uppercase tracking-wider">+{{ $event->points_bonus }} Pts</span>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('guru.events.award.process', $event->id) }}" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <h4 class="text-xs font-black text-slate-950 uppercase tracking-wider">Pilih Siswa yang Berpartisipasi:</h4>
